 ...
 */
public class VinoigitareTest extends TestBenchTestCase {
	@Rule
	...
	private void openTestUrl() {
		getDriver().get("http://localhost:8080/Vinoigitare");
	}
	...
	public void testClickButton() throws Exception {
		...
		assertEquals("Thank you for clicking", $(LabelElement.class).first()
				.getText());
